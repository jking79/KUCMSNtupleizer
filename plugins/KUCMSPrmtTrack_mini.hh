...
#ifndef KUCMSPrmtTrackObjectMiniHeader
#define KUCMSPrmtTrackObjectMiniHeader
...
class KUCMSPrmtTrackObjectMini : public KUCMSObjectBase {
    ...
    KUCMSPrmtTrackObjectMini( const edm::ParameterSet& iConfig );
    //KUCMSPrmtTrackObjectMini( const edm::ParameterSet& iConfig );
    ~KUCMSPrmtTrackObjectMini(){};
...
KUCMSPrmtTrackObjectMini::KUCMSPrmtTrackObjectMini( const edm::ParameterSet& iConfig ){   
...
void KUCMSPrmtTrackObjectMini::InitObject( TTree* fOutTree ){
...
void KUCMSPrmtTrackObjectMini::LoadEvent( const edm::Event& iEvent, const edm::EventSetup& iSetup, ItemManager<float>& geVar ){
...
void KUCMSPrmtTrackObjectMini::PostProcessEvent( ItemManager<float>& geVar ){

}//<<>>void KUCMSPrmtTrackObjectMini::PostProcessEvent( ItemManager<float>& geVar )

void KUCMSPrmtTrackObjectMini::ProcessEvent( ItemManager<float>& geVar ){
...
void KUCMSPrmtTrackObjectMini::EndJobs(){}

// paramters form PhysicsTools/PatAlgos/pythin/slimming/isolatedTracks_cfi.py
void KUCMSPrmtTrackObjectMini::getTrkIso(const PolarLorentzVector& p4, int pc_idx, pat::PFIsolation& iso, pat::PFIsolation& miniiso) const {
...
}//<<>>void KUCMSPrmtTrackObjectMini::getTrkIso(const PolarLorentzVector& .....
