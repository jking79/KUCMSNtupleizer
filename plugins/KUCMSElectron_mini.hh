...
#ifndef KUCMSElectronObjectMiniHeader
#define KUCMSElectronObjectMiniHeader
...
class KUCMSElectronObjectMini : public KUCMSObjectBase {
    ...
    KUCMSElectronObjectMini( const edm::ParameterSet& iConfig );
    //KUCMSElectronObjectMini( const edm::ParameterSet& iConfig );
    ~KUCMSElectronObjectMini(){};
    ...
    void LoadElectronTokens( edm::EDGetTokenT<edm::View<pat::Electron>> electronsToken ){ electronsToken_ = electronsToken; }; 
	...
	float getEleTrackZMatch( const pat::Photon & photon ); 
    ...
    edm::Handle<edm::View<pat::PackedCandidate>> pfcands_;
...
KUCMSElectronObjectMini::KUCMSElectronObjectMini( const edm::ParameterSet& iConfig ) :
...
void KUCMSElectronObjectMini::InitObject( TTree* fOutTree ){
...
void KUCMSElectronObjectMini::LoadEvent( const edm::Event& iEvent, const edm::EventSetup& iSetup, ItemManager<float>& geVar ){
    ...
    for (edm::View<pat::Electron>::const_iterator itElectron = electrons_->begin(); itElectron != electrons_->end(); itElectron++) {
...
void KUCMSElectronObjectMini::PostProcessEvent( ItemManager<float>& geVar ){

}//<<>>void KUCMSElectronObject::PostProcessEvent( ItemManager<float>& geVar )

void KUCMSElectronObjectMini::ProcessEvent( ItemManager<float>& geVar ){
...
void KUCMSElectronObjectMini::EndJobs(){}

float KUCMSElectronObjectMini::getEleTrackZMatch( const pat::Photon & photon ){
...
int KUCMSElectronObjectMini::getIndex( float kideta, float kidphi ){
