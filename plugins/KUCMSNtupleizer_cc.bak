...
#include "LLPGamma/LLPgammaAnalyzer/plugins/KUCMSNtupilizer.hh"
using namespace std;
...
/*
detIdMap KUCMSNtupilizer::SetupDetIDs(){
...
rhGroup KUCMSNtupilizer::getRHGroup( const scGroup superClusterGroup, float minenr, vector<float> phEnergy, vector<float> phDr, float phEnMax ){
...
rhGroup KUCMSNtupilizer::getRHGroup( const scGroup superClusterGroup, float minenr, vector<float> phEnergy, vector<float> phDr, float phEnMax, TH1D* rhTimeHist, TH1D* ootHist, TH1D* matchHist ){
...
}//>>>>rhGroup KUCMSNtupilizer::getRHGroup( const scGroup superClusterGroup, float minenr, vector<float> phEnergy, vector<float> phDr, float phEnMax, TH1D ootHist, ... )

rhGroup KUCMSNtupilizer::getRHGroup( const scGroup superClusterGroup, float minenr, TH1D* rhTimeHist, TH1D* ootHist, TH1D* matchHist ){
...
}//>>>>rhGroup KUCMSNtupilizer::getRHGroup( const scGroup superClusterGroup, float minenr, TH1D ootHist, ... )
...
vector<float> KUCMSNtupilizer::getTimeDistStats( vector<float> times ){
...
vector<float> KUCMSNtupilizer::getTimeDistStats( vector<float> times, vector<float> wts ){
	...
	return results;
}//>>>>vector<float> KUCMSNtupilizer::getTimeDistStats( vector<float> times, vector<float> weights )
...
vector<float> KUCMSNtupilizer::getRhGrpEigen( vector<float> xs, vector<float> wts ){
//spherical
    ...
    return results;
}//<<>>vector<float> KUCMSNtupilizer::getRhGrpEigen2D( vector<float> xs, vector<float> ys, vector<float> zs, vector<float> wts )

vector<float> KUCMSNtupilizer::getRhGrpEigen( vector<float> xs, vector<float> ys, vector<float> wts ){
...
vector<float> KUCMSNtupilizer::getRhGrpEigen( vector<float> xs, vector<float> ys, vector<float> zs, vector<float> wts ){
// ieipt
	...
	return results;
}//<<>>vector<float> KUCMSNtupilizer::getRhGrpEigen3D( vector<float> xs, vector<float> ys, vector<float> zs, vector<float> wts )

vector<float> KUCMSNtupilizer::getRhGrpEigen_ieipt( vector<float> times, rhGroup rechits ){
    ...
    return eigens;
}//>>>>vector<float> KUCMSNtupilizer::getRhGrpEigen( vector<float> times, rhGroup rechits ){

vector<float> KUCMSNtupilizer::getRhGrpEigen_xyz( vector<float> times, rhGroup rechits ){
...
vector<float> KUCMSNtupilizer::getRhGrpEigen_sph( vector<float> times, rhGroup rechits ){
...
vector<float> KUCMSNtupilizer::getRhGrpEigen_ep( vector<float> times, rhGroup rechits ){
...
float KUCMSNtupilizer::getdt( float t1, float t2 ){
