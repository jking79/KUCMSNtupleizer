...
#ifndef KUCMSPFMetObjectMiniHeader
#define KUCMSPFMetObjectMiniHeader
...
class KUCMSPFMetObjectMini : public KUCMSObjectBase {

    public:

    // use base class constructor
    KUCMSPFMetObjectMini( const edm::ParameterSet& iConfig );
    ~KUCMSPFMetObjectMini(){};
    ...
    void LoadPFMetTokens( edm::EDGetTokenT<std::vector<pat::MET>> pfmetsToken ){ pfmetsToken_ = pfmetsToken; }; 
	...
	void LoadPhotonObject( KUCMSPhotonObjectMini* otherObject ){ phoObj = otherObject; };
...
void KUCMSPFMetObjectMini::InitObject( TTree* fOutTree ){
...
void KUCMSPFMetObjectMini::LoadEvent( const edm::Event& iEvent, const edm::EventSetup& iSetup, ItemManager<float>& geVar ){
...
void KUCMSPFMetObjectMini::ProcessEvent( ItemManager<float>& geVar ){}

void KUCMSPFMetObjectMini::PostProcessEvent( ItemManager<float>& geVar ){
...
void KUCMSPFMetObjectMini::EndJobs(){}
