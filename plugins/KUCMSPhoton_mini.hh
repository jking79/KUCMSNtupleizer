...
#ifndef KUCMSPhotonObjectMiniHeader
#define KUCMSPhotonObjectMiniHeader
...
typedef edm::View<pat::Photon> phoColView;

class KUCMSPhotonObjectMini : public KUCMSObjectBase {

    public:

    // use base class constructor
    KUCMSPhotonObjectMini( const edm::ParameterSet& iConfig );
    ~KUCMSPhotonObjectMini(){};
    ...
    void LoadGenObject( KUCMSGenObjectMini*  genObj_ ){ genObj = genObj_; };
    void LoadElectronObject( KUCMSElectronObjectMini* electronObj_ ){ electronObj = electronObj_; };
	...
	bool passPhoQuality( const pat::Photon & photon );
    ...
    KUCMSGenObjectMini*  genObj;
    KUCMSElectronObjectMini* electronObj;

};//<<>>class KUCMSPhoton : public KUCMSObjectBase

KUCMSPhotonObjectMini::KUCMSPhotonObjectMini( const edm::ParameterSet& iConfig ){   
...
void KUCMSPhotonObjectMini::LoadPhotonTokens( edm::EDGetTokenT<phoColView> gedPhotonsToken, edm::EDGetTokenT<phoColView> ootPhotonsToken ){
...
void KUCMSPhotonObjectMini::InitObject( TTree* fOutTree ){
...
void KUCMSPhotonObjectMini::LoadEvent( const edm::Event& iEvent, const edm::EventSetup& iSetup, ItemManager<float>& geVar ){
...
void KUCMSPhotonObjectMini::PostProcessEvent( ItemManager<float>& geVar ){}

void KUCMSPhotonObjectMini::ProcessEvent( ItemManager<float>& geVar ){
...
void KUCMSPhotonObjectMini::EndJobs(){}

float KUCMSPhotonObjectMini::getPhotonSeedTime( reco::Photon photon ){
...
float KUCMSPhotonObjectMini::getPhotonSeedTime( pat::Photon photon ){
...
int KUCMSPhotonObjectMini::getIndex( float kideta, float kidphi ){
...
}//<<>>uInt KUCMSPhotonObjectMini::getIndex( float kideta, float kidphi )

void KUCMSPhotonObjectMini::correctMet( float & CSumEt, float & CPx, float & CPy ){
...
bool KUCMSPhotonObjectMini::passPhoQuality( const pat::Photon & photon ){
