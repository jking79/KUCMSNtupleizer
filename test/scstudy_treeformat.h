...
// Mon Apr  1 12:40:38 2024 by ROOT version 6.26/11
// from TTree llpgtree/KUCMSNtuple
// found on file: gmsb_AODSIM_KUCMSNtuplizer_Objectified_v17_scstudy_oottrue.root
//////////////////////////////////////////////////////////

#ifndef scstudy_treeformat_h
#define scstudy_treeformat_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   scstudy_treeformat(TTree *tree=0);
   virtual ~scstudy_treeformat();
...
#ifdef scstudy_treeformat_cxx
scstudy_treeformat::scstudy_treeformat(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("gmsb_AODSIM_KUCMSNtuplizer_Objectified_v17_scstudy_oottrue.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("gmsb_AODSIM_KUCMSNtuplizer_Objectified_v17_scstudy_oottrue.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("gmsb_AODSIM_KUCMSNtuplizer_Objectified_v17_scstudy_oottrue.root:/tree");
...
scstudy_treeformat::~scstudy_treeformat()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t scstudy_treeformat::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t scstudy_treeformat::LoadTree(Long64_t entry)
{
...
void scstudy_treeformat::Init(TTree *tree)
{
...
Bool_t scstudy_treeformat::Notify()
{
...
void scstudy_treeformat::Show(Long64_t entry)
{
...
Int_t scstudy_treeformat::Cut(Long64_t entry)
{
...
#endif // #ifdef scstudy_treeformat_cxx
