...
// Fri Jul 11 14:20:14 2025 by ROOT version 6.26/11
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   std::vector<vector<float> > *SuperCluster_rhFracs;
   std::vector<vector<unsigned int> > *SuperCluster_rhIds;
   ...
   std::vector<float>   *Electron_dRGenMatch;
   ...
   std::vector<vector<unsigned int> > *Jet_drRhIds;
   ...
   std::vector<vector<unsigned int> > *Jet_egIndxs;
   ...
   std::vector<float>   *Muon_dRGenMatch;
   ...
   std::vector<vector<unsigned int> > *Photon_gloResRhId;
   ...
   std::vector<vector<unsigned int> > *Photon_locResRhId;
...
void llpgtree::Init( TTree *tree, bool doGenInfo )
{
   ...
   // - moved - fChain->SetBranchAddress("ECALTrack_pdgId", &ECALTrack_pdgId, &b_ECALTrack_pdgId);
   ...
   fChain->SetBranchAddress("Electron_dRGenMatch", &Electron_dRGenMatch, &b_Electron_dRGenMatch);
   ...
   fChain->SetBranchAddress("Muon_dRGenMatch", &Muon_dRGenMatch, &b_Muon_dRGenMatch);
...
void llpgtree::getBranches( Long64_t entry, bool doGenInfo ){
   ...
   b_Electron_dRGenMatch->GetEntry(entry);   //!
   ...
   b_Muon_dRGenMatch->GetEntry(entry);   //!
