...
#ifndef kuntuple_v16_h
#define kuntuple_v16_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<vector<float> > *SuperCluster_MissingRhFracs;
   ...
   kuntuple_v16(TTree *tree=0);
   virtual ~kuntuple_v16();
...
#ifdef kuntuple_v16_cxx
kuntuple_v16::kuntuple_v16(TTree *tree) : fChain(0) 
{
...
kuntuple_v16::~kuntuple_v16()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t kuntuple_v16::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t kuntuple_v16::LoadTree(Long64_t entry)
{
...
void kuntuple_v16::Init(TTree *tree)
{
...
void kuntuple_v16::Show(Long64_t entry)
{
...
Int_t kuntuple_v16::Cut(Long64_t entry)
{
