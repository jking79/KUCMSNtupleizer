...
def docrab( dataset ):
    ...
    if options.crabCmd == 'submit':
        ...
        for inDO in inputDataAndOpts:
            ...
            #trial          = "kucmsntuple_WJets_R18_SVHPM100_MiniAOD" + version
            #trial          = "kucmsntuple_DTBoson_R18_SVHPM100"  + version
            #trial          = "kucmsntuple_DiPJBox_R18_SVHPM100" + version
...
def run_multi():
    ...
    runDataset = [
        ...
        #['/ZJetsToNuNu_HT-100To200_'+TuneCP5MP+'/'+RunIIS+'-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM',1],
        #['/ZJetsToNuNu_HT-1200To2500_'+TuneCP5MP+'/'+RunIIS+'-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM',1],
        #['/ZJetsToNuNu_HT-200To400_'+TuneCP5MP+'/'+RunIIS+'-106X_upgrade2018_realistic_v16_L1v1-v2/MINIAODSIM',1],
        #['/ZJetsToNuNu_HT-2500ToInf_'+TuneCP5MP+'/'+RunIIS+'-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM',1],
        #['/ZJetsToNuNu_HT-400To600_'+TuneCP5MP+'/'+RunIIS+'-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM',1],
        #['/ZJetsToNuNu_HT-600To800_'+TuneCP5MP+'/'+RunIIS+'-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM',1],
        #['/ZJetsToNuNu_HT-800To1200_'+TuneCP5MP+'/'+RunIIS+'-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM',1],

        #['/WJetsToLNu_HT-70To100_'+TuneCP5MP+'/'+RunIIS+'-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM',1],
        #['/WJetsToLNu_HT-100To200_'+TuneCP5MP+'/'+RunIIS+'-106X_upgrade2018_realistic_v16_L1v1-v2/MINIAODSIM',1],
        #['/WJetsToLNu_HT-200To400_'+TuneCP5MP+'/'+RunIIS+'-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM',1],
        #['/WJetsToLNu_HT-400To600_'+TuneCP5MP+'/'+RunIIS+'-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM',1],
        #['/WJetsToLNu_HT-600To800_'+TuneCP5MP+'/'+RunIIS+'-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM',1],
        #['/WJetsToLNu_HT-800To1200_'+TuneCP5MP+'/'+RunIIS+'-106X_upgrade2018_realistic_v16_L1v1-v1/MINIAODSIM',1],
