...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   kuntuple_v15(TTree *tree=0);
   virtual ~kuntuple_v15();
...
#ifdef kuntuple_v15_cxx
kuntuple_v15::kuntuple_v15(TTree *tree) : fChain(0) 
{
...
kuntuple_v15::~kuntuple_v15()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t kuntuple_v15::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t kuntuple_v15::LoadTree(Long64_t entry)
{
...
void kuntuple_v15::Init(TTree *tree)
{
...
void kuntuple_v15::Show(Long64_t entry)
{
...
Int_t kuntuple_v15::Cut(Long64_t entry)
{
