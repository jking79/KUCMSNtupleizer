...
#command = eosll+mdis+'KUCMSNtuple/kucmsntuple_GJETS_R17_v19_Met75/'
command = eosll+mdis+'KUCMSNtuple/kucmsntuple_QCD_R17_v19_MET75/'
command = eosll+mdis+'KUCMSNtuple/kucmsntuple_DEG_R17_v18/'
...
for line2 in targdirs :
    ...
    outfile = 'kuntuple_' + select[0] + 'Met150_R17_v18.txt'
    #print( outfile )
    outf = open( outfile, 'w' )
