...
#    legend.SetHeader(layout['legtitle'], '')
    ...
    for histname, infile1, lego, cutside in hist_list :
...
sig100 = "rjr_multihist_files/KUCMS_GMSB_L100_GluGlu_v19_genSigPerfect_nSigPho1_wt2_RjrSkim_v22_ootmet_phomet_multiHists.root"
sig150 = "rjr_multihist_files/KUCMS_GMSB_L150_GluGlu_v19_genSigPerfect_nSigPho1_wt2_RjrSkim_v22_ootmet_phomet_multiHists.root"
sig200 = "rjr_multihist_files/KUCMS_GMSB_L200_GluGlu_v19_genSigPerfect_nSigPho1_wt2_RjrSkim_v22_ootmet_phomet_multiHists.root"
sig250 = "rjr_multihist_files/KUCMS_GMSB_L250_GluGlu_v19_genSigPerfect_nSigPho1_wt2_RjrSkim_v22_ootmet_phomet_multiHists.root"
sig300 = "rjr_multihist_files/KUCMS_GMSB_L300_GluGlu_v19_genSigPerfect_nSigPho1_wt2_RjrSkim_v22_ootmet_phomet_multiHists.root"
sig350 = "rjr_multihist_files/KUCMS_GMSB_L350_GluGlu_v19_genSigPerfect_nSigPho1_wt2_RjrSkim_v22_ootmet_phomet_multiHists.root"
sig400 = "rjr_multihist_files/KUCMS_GMSB_L400_GluGlu_v19_genSigPerfect_nSigPho1_wt2_RjrSkim_v22_ootmet_phomet_multiHists.root"


boutname = 'llpa_rjr_sig_'
title = ' 2017 GMSB GluGlu'
ptnorm = ''
#isonorm = 'hadTowOverEM < 0.02'
isonorm = ''
ptlist = [ '' ]
#ptlist = [ '100','300' ]
ptitle=[ title, ptnorm+ptlist[0], isonorm ]

inhistlist = [[rhnamea[0],sig100,"M_{\Chi_{1}} = 139",norm],
            [rhnamea[0],sig150,"M_{\Chi_{1}} = 212",norm],
            [rhnamea[0],sig200,"M_{\Chi_{1}} = 285",norm],
            [rhnamea[0],sig250,"M_{\Chi_{1}} = 358",norm],
            [rhnamea[0],sig300,"M_{\Chi_{1}} = 430",norm],
            [rhnamea[0],sig350,"M_{\Chi_{1}} = 503",norm],
            [rhnamea[0],sig400,"M_{\Chi_{1}} = 576",norm],
            ]

date = time.strftime('%d%m%Y') +  time.strftime('%H%M%S')
outname = boutname + rhnamea[0]
layout = { 'xtitle' : rhnamea[0], 'ytitle' : ytitle, 'title' : htitle, 'logx' : islogx, 'logy' : islogy, 'legtitle' : legtitle }
