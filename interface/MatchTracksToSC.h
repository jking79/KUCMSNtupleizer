...
//#include "TimingWithSVs/SVsTimingProducer/interface/ElectronTools.h"
...
template <class T> class MatchedTrackSCPair {
 ...
 MatchedTrackSCPair(const MatchedPair &pairInfo, 
  ...
  // Getter functions
  int GetGenIndex() const { return genMatchIndex_; }
  ...
  double GetGenDeltaR() const { return genMatchDeltaR_; }
