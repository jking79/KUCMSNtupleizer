...
public:
  ...
  float getTimeSig( int scIndex, float& num, float& denom, float syst = 0.f, const map<unsigned int, float>& rhIdToBHCw  = {});
  ...
  std::vector<float> allphominjetdr;
