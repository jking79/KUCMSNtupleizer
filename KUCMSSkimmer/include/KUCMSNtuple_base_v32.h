...
// Tue Feb  3 16:07:06 2026 by ROOT version 6.34.02
// from TTree llpgtree/KUCMSNtuple
// found on file: kucmsntuple.root
//////////////////////////////////////////////////////////

#ifndef llpgtree_ntuple_base_h
#define llpgtree_ntuple_base_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *ECALRecHit_bsx;
   vector<float>   *ECALRecHit_bsy;
   vector<float>   *ECALRecHit_bsz;
   ...
   Bool_t          HLT_PFMET100_PFMHT100_IDTight_v;
   Bool_t          HLT_PFMET120_PFMHT120_IDTight_PFHT60_v;
   Bool_t          HLT_PFMET120_PFMHT120_IDTight_v;
   Bool_t          HLT_PFMET130_PFMHT130_IDTight_v;
   Bool_t          HLT_PFMET140_PFMHT140_IDTight_v;
   Bool_t          HLT_PFMET90_PFMHT90_IDTight_v;
   Bool_t          HLT_PFMETNoMu100_PFMHTNoMu100_IDTight_v;
   Bool_t          HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_PFHT60_v;
   Bool_t          HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_v;
   Bool_t          HLT_PFMETNoMu130_PFMHTNoMu130_IDTighti_v;
   Bool_t          HLT_PFMETNoMu140_PFMHTNoMu140_IDTight_v;
   Bool_t          HLT_PFMETNoMu90_PFMHTNoMu90_IDTight_v;
   ...
   TBranch        *b_ECALRecHit_bsx;   //!
   TBranch        *b_ECALRecHit_bsy;   //!
   TBranch        *b_ECALRecHit_bsz;   //!
   ...
   TBranch        *b_HLT_PFMET100_PFMHT100_IDTight_v;   //!
   TBranch        *b_HLT_PFMET120_PFMHT120_IDTight_PFHT60_v;   //!
   TBranch        *b_HLT_PFMET120_PFMHT120_IDTight_v;   //!
   TBranch        *b_HLT_PFMET130_PFMHT130_IDTight_v;   //!
   TBranch        *b_HLT_PFMET140_PFMHT140_IDTight_v;   //!
   TBranch        *b_HLT_PFMET90_PFMHT90_IDTight_v;   //!
   TBranch        *b_HLT_PFMETNoMu100_PFMHTNoMu100_IDTight_v;   //!
   TBranch        *b_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_PFHT60_v;   //!
   TBranch        *b_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_v;   //!
   TBranch        *b_HLT_PFMETNoMu130_PFMHTNoMu130_IDTighti_v;   //!
   TBranch        *b_HLT_PFMETNoMu140_PFMHTNoMu140_IDTight_v;   //!
   TBranch        *b_HLT_PFMETNoMu90_PFMHTNoMu90_IDTight_v;   //!
...
void Init(TTree *tree ){
  ...
  if( doSVsBase ){
   ...
   fChain->SetBranchAddress("ECALRecHit_bsx", &ECALRecHit_bsx, &b_ECALRecHit_bsx);
   fChain->SetBranchAddress("ECALRecHit_bsy", &ECALRecHit_bsy, &b_ECALRecHit_bsy);
   fChain->SetBranchAddress("ECALRecHit_bsz", &ECALRecHit_bsz, &b_ECALRecHit_bsz);
   ...
   //fChain->SetBranchAddress("HLT_PFMET130_PFMHT130_IDTight_v", &HLT_PFMET130_PFMHT130_IDTight_v, &b_HLT_PFMET130_PFMHT130_IDTight_v);
   //fChain->SetBranchAddress("HLT_PFMET140_PFMHT140_IDTight_v", &HLT_PFMET140_PFMHT140_IDTight_v, &b_HLT_PFMET140_PFMHT140_IDTight_v);
   //fChain->SetBranchAddress("HLT_PFMET90_PFMHT90_IDTight_v", &HLT_PFMET90_PFMHT90_IDTight_v, &b_HLT_PFMET90_PFMHT90_IDTight_v);
   //fChain->SetBranchAddress("HLT_PFMETNoMu100_PFMHTNoMu100_IDTight_v", &HLT_PFMETNoMu100_PFMHTNoMu100_IDTight_v, &b_HLT_PFMETNoMu100_PFMHTNoMu100_IDTight_v);
...
void getBranches( Long64_t entry ){
  ...
  if( doSVsBase ){
   ...
   b_Vertex_nearestGenVertexIndex->GetEntry(entry);
   }//<<>>if( doGenInfoBase )
   ...
   b_ECALRecHit_bsz->GetEntry(entry);
   ...
   b_Electron_hasGenMatch->GetEntry(entry);
   b_Electron_isLWZP->GetEntry(entry);
   b_Electron_nGenMatch->GetEntry(entry);
   }//<<>>if( doGenInfoBase )
   ...
   //TBranch        *b_Flag_BadPFMuonSummer16Filter->GetEntry(entry);
   //TBranch        *b_Flag_CSCTightHalo2015Filter->GetEntry(entry);
   //TBranch        *b_Flag_CSCTightHaloFilter->GetEntry(entry);
   //TBranch        *b_Flag_CSCTightHaloTrkMuUnvetoFilter->GetEntry(entry);
   //TBranch        *b_Flag_EcalDeadCellBoundaryEnergyFilter->GetEntry(entry);
   ...
   //TBranch        *b_Flag_HcalStripHaloFilter->GetEntry(entry);
   //TBranch        *b_Flag_METFilters->GetEntry(entry);
   //TBranch        *b_Flag_chargedHadronTrackResolutionFilter->GetEntry(entry);
   b_Flag_ecalBadCalibFilter->GetEntry(entry);
   //TBranch        *b_Flag_ecalLaserCorrFilter->GetEntry(entry);
   b_Flag_eeBadScFilter->GetEntry(entry);
   b_Flag_globalSuperTightHalo2016Filter->GetEntry(entry);
   //TBranch        *b_Flag_globalTightHalo2016Filter->GetEntry(entry);
   b_Flag_goodVertices->GetEntry(entry);
   //TBranch        *b_Flag_hcalLaserEventFilter->GetEntry(entry);
   b_Flag_hfNoisyHitsFilter->GetEntry(entry);
   //TBranch        *b_Flag_muonBadTrackFilter->GetEntry(entry);
   //TBranch        *b_Flag_trkPOGFilters->GetEntry(entry);
   //TBranch        *b_Flag_trkPOG_logErrorTooManyClusters->GetEntry(entry);
   ...
   //TBranch        *b_HLT_PFMET130_PFMHT130_IDTight_v->GetEntry(entry);
   //TBranch        *b_HLT_PFMET140_PFMHT140_IDTight_v->GetEntry(entry);
   //TBranch        *b_HLT_PFMET90_PFMHT90_IDTight_v->GetEntry(entry);
   //TBranch        *b_HLT_PFMETNoMu100_PFMHTNoMu100_IDTight_v->GetEntry(entry);
   ...
   if( doGenInfoBase ){
   if( doNewSigBase ){
   b_Xa_energy->GetEntry(entry);
   b_Xa_phi->GetEntry(entry);
   b_Xa_mass->GetEntry(entry);
   ...
   b_Xa_vz->GetEntry(entry);
   b_Xa_beta->GetEntry(entry);
   b_Xa_ctau->GetEntry(entry);
   b_Xb_energy->GetEntry(entry);
   b_Xb_phi->GetEntry(entry);
   b_Xb_mass->GetEntry(entry);
   ...
   b_Xb_vz->GetEntry(entry);
   b_Xb_beta->GetEntry(entry);
   b_Xb_ctau->GetEntry(entry);
   b_Evt_fsType->GetEntry(entry);
   }//<<>>if( doGenInfoBase )
   }//<<>>if( doNewSigBase )
   ...
   if( doNewSigBase ){
   b_Evt_isGG->GetEntry(entry);
   b_Evt_isGZ->GetEntry(entry);
   b_Evt_isZZ->GetEntry(entry);
   b_Evt_nXs->GetEntry(entry);
   }//<<>>if( doNewSigBase )
   }//<<>>if( doGenInfoBase )
   ...
   b_Muon_hasGenMatch->GetEntry(entry);
   b_Muon_isLWZP->GetEntry(entry);
